...
public class RegisteredUserDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registered_user_dashboard);
        ...
        try {
            ...
            Toast.makeText(RegisteredUserDashboard.this, "Connection Successful", Toast.LENGTH_SHORT).show();
        } catch (ClassNotFoundException | SQLException e) {
            e.printStackTrace();
            Toast.makeText(RegisteredUserDashboard.this, "Error connecting", Toast.LENGTH_SHORT).show();
        }
    ...
    public void RegisterNewUser(View view){
        if(con!=null){
            ...
            try {
                ...
                Toast.makeText(RegisteredUserDashboard.this, "Successfully Saved!", Toast.LENGTH_SHORT).show();
            } catch (SQLException e) {
                e.printStackTrace();
            }

        }else{
            Toast.makeText(RegisteredUserDashboard.this, "Error in connecting", Toast.LENGTH_SHORT).show();
        }
    }
}